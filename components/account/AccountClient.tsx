...
type MePayload = {
  ...
  credits: number;
  exports: Array<{ id: string; platform: string; export_mode: string; status: string; stage?: string; credit_cost: number; file_name?: string | null; export_number?: number | null; application_id?: string | null; export_name?: string | null; error?: string | null; error_code?: string | null; duration_ms?: number | null; created_at: string }>;
  error?: string;
};
