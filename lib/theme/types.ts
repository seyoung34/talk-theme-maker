...
export type ThemeResourceRole =
  ...
  | "bubble_you_1"
  | "bubble_you_2"
  | "bubble_me_1_selected"
  | "bubble_me_2_selected"
  | "bubble_you_1_selected"
  | "bubble_you_2_selected"
  | "chat_bubble_me_color"
  | "chat_bubble_you_color"
  | "chat_bubble_me_selected_color"
  | "chat_bubble_you_selected_color"
  ...
  | "direct_share_name_color"
  | "notification_text_color"
  | "notification_background_color"
  | "notification_background_pressed_color"
  | "notification_name_color"
  | "bottom_banner_background_color"
  | "passcode_background"
