...
function buildIosThemeCss({
  ...
  return [
    ...
    "{",
    cssLine("background-color", color("passcode_background_color", "#ECEDEF")),
    cssImageLine("-ios-background-image", imageMap.passcode_background),
    "}",
    "",
    "LabelStyle-PasscodeTitle",
    "{",
    cssLine("-ios-text-color", color("passcode_color", "#111111")),
    "}",
    "",
    "PasscodeStyle",
    "{",
    ...
    cssLine("-ios-keypad-background-color", color("passcode_keypad_background_color", "#FFFFFF")),
    cssLine("-ios-keypad-text-normal-color", color("passcode_keypad_color", "#111111")),
