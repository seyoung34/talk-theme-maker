...
describe("canonical admin asset variants", () => {
  it("preserves platform files and an editable bubble recipe", () => {
    ...
    const asset = mapCanonicalAdminAssetRow({
      ...
      admin_asset_bubble_specs: [{ asset_id: "9ad40a53-314b-49d9-93f2-2b28a69cbfb0", android_markers: markers, ios_insets: { top: 12, right: 12, bottom: 12, left: 12 }, ios_stretch: { x: 20, y: 20 } }],
