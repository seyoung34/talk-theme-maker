...
export const guideContent: Record<GuidePlatform, PlatformGuide> = {
    ...
    sections: [
      ...
      },
      {
        ...
        steps: [
          ...
          { title: "Play 프로텍트 차단 해제", body: "‘기기 보호를 위해 앱 차단됨’ 창이 뜨면 ‘세부정보 더보기’를 펼친 뒤 ‘무시하고 설치하기’를 선택합니다. 펼치기 전에는 설치를 계속할 버튼이 보이지 않습니다." },
  ...
  ios: {
    ...
    easySteps: [
      ...
      {
        title: "테마 파일 만들기",
        caption: "‘다운로드’를 누르면 이름과 크레딧을 확인하는 창이 열려요. 서버가 만드는 동안 창을 닫아도 괜찮아요.",
        actions: [
          "오른쪽 위 ‘다운로드’를 눌러요. 테마 이름과 필요한 크레딧을 확인하는 창이 열려요.",
          "‘다운로드 시작’을 누르면 서버가 .ktheme 파일을 만들기 시작해요.",
          "만드는 동안 창을 닫거나 다른 일을 해도 돼요. 다 만들어지면 내 계정에서 받을 수 있어요.",
